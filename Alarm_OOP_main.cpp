...
int main()
{
  Alarm my_alarm;            // instantiate object t of class Alarm
  int h, m, s, type;
  ...
  cout << "default view of the clock is UNIVERSAL, to stay in this mode enter 1.\nif you want to switch to STANDARD view enter 0 :  ";
  cin >> type;
